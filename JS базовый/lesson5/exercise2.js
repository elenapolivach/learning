...
/**
    ...
    const player = {
      ...
      move(direction) {
        ...
        switch (direction) {
            case 1:
              if (this.x == settings.minPosition || this.y == settings.maxPosition) {
                    this.x;
                    this.y;
                    break;
              } else {
            ...
            case 2:
              if (this.y == settings.maxPosition) {
                    this.y;
                    break;
              } else {
                    this.y++;
            ...
            case 3:
                if (this.x == settings.maxPosition || this.y == settings.maxPosition) {
                    this.x;
                    this.y;
                    break;
                } else {
            ...
            case 4:
              if (this.x == settings.minPosition) {
                    this.x;
                    break;
              } else {
                    this.x--;
            ...
            case 6:
              if (this.x == settings.maxPosition) {
                    this.x;
                    break;
              } else {
                    this.x++;
            ...
            case 7:
              if(this.x == settings.minPosition || this.y == settings.minPosition) {
                    this.x;
                    this.y;
                    break;
                } else {
            ...
            case 8:
              if (this.y == settings.minPosition) {
                    this.y;
                    break;
              } else {
                    this.y--;
            ...
            case 9:
                if(this.x == settings.maxPosition || this.y == settings.minPosition) {
                    this.x;
                    this.y;
                    break;
                } else {
